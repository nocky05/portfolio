...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    pitch: "L'expert IA pour comparer les banques et fintechs en Côte d'Ivoire — transparence, économies et conseils impartiaux.",
    category: "Web",
    tag: "Full-Stack · Fintech Solution",
    stack: ["Next.js", "TypeScript", "Supabase", "Tailwind CSS", "AI Agent (LLM)"],
